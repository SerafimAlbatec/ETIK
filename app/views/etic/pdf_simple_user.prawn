pdf.bounding_box [pdf.bounds.left, pdf.bounds.top - 105], :width  => pdf.bounds.width, :height => pdf.bounds.height - 160 do
...
pdf.repeat :all do
pdf.bounding_box [pdf.bounds.left, pdf.bounds.top + 35], :width  => pdf.bounds.width do
       pdf.font "#{Rails.root}/app/assets/fonts/DejaVuSans.ttf"
